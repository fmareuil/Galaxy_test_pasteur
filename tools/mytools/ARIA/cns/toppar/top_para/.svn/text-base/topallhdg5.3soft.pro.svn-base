...
! MN new ZN patches, don't change residue names, do everything at once
! patch with 
!   PATCh ZNC3 refer=1=(first cys) refer=2=(second cys) refer=3=(third cys) refer=4=(histidine)
! charges are random at the moment

presidue SSSE
    add       atom 1ZN  type=ZN_1   charge= 2.000    end
...
! angles across ZN
    add angle 1SG 1ZN 2SG
    add angle 1SG 1ZN 3SG
    add angle 1SG 1ZN 4SG
    add angle 2SG 1ZN 3SG
    add angle 2SG 1ZN 4SG
    add angle 3SG 1ZN 4SG
end
