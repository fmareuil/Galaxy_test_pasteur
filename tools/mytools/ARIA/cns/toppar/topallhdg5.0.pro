remark   file parallhdg.pro  version 4.01  date 29-Jul-96
remark   file topallhdg.pro  version 4.01  date 29-Jul-96
...
presidue PEPP     ! for  ...*(-) - (+)PRO  link, same as PEPT except
  ...
  add improper +CD +N  -C  -CA                      ! planar +N modified, again
  add improper -CA  -C +N +CA                       ! planar peptide
end
...
!  add    improper +CA +N  +CD -C
  delete improper +CD +N  -C  -CA                     
  add    improper +N  +CD -C  -CA
end
