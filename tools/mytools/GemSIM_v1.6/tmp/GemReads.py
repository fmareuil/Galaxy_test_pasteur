...
def getMetL(Liste,genListe, abund):
    """Returns the genomes in a directory, with weights."""
    refDict={}
    comDict={}
    genDict={}
...
##MAREUIL
    print '      -L Only for metagenome projects. Liste of references. Between quote and separate by space'
##MAREUIL
 ...
 ##MAREUIL
    print '      -H Liste of haplotype files. Between quote and separate by space'
##MAREUIL   
...
##MAREUIL
    ...
    stdv=''
    try:
        opts, args = getopt.getopt(argv, "hr:R:L:a:n:g:G:H:l:m:ce:q:o:u:s:p")
...
##MAREUIL
        if List == '':
            ...
            refDict,genDict,comDict,refList=getMetL(List,genList, abund)
##MAREUIL
    else:
        if gens!='':
            gens=gParse(gens)
