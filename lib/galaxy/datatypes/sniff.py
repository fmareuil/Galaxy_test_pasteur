...
#from galaxy.datatypes.checkers import check_binary, check_html, is_gzip  #add new  compressed type
from galaxy.datatypes.checkers import * #add new  compressed type
...
#COMPRESSION_CHECK_FUNCTIONS = [ ( 'gzip', is_gzip ) ] # add new  compressed type
#COMPRESSION_DATATYPES = dict( gzip = [ 'bam' ] ) # add new  compressed type
COMPRESSION_CHECK_FUNCTIONS = [ ( 'gzip', is_gzip ), ('bz2', is_bz2), ('zip', check_zip) ] # add new  compressed type
COMPRESSION_DATATYPES = dict( gzip = [ 'bam', 'fastq.gz', 'tar.gz' ], bz2 = ['fastq.bz2', 'tar.bz2'], zip = ['zip'] ) # add new  compressed type
