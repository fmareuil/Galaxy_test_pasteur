...
import socket
import sys #PATCH GALAXY REMOTE_USER FABIEN MAREUIL
...
class RemoteUser( object ):
    ...
    def __call__( self, environ, start_response ):
        ...
        if self.display_servers and environ.has_key( 'REMOTE_ADDR' ):
            ...
            if hostaddr :                                               #PATCH PASTEUR MAREUIL
                for display_server in self.display_servers:             #PATCH PASTEUR MAREUIL
                    if hostaddr.startswith(display_server):             #PATCH PASTEUR MAREUIL
                        environ[ self.remote_user_header ] = 'remote_display_server@%s' % ( self.maildomain or 'example.org' )    #PATCH PASTEUR MAREUIL
                        return self.app( environ, start_response )      #PATCH PASTEUR MAREUIL
